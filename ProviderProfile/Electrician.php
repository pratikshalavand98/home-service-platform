            ...
            <div class="content_info">
                <div class="paddings">
                    <div class="container">
                        <div class="row">
                            <div class="col-md-6">
                                <h3>Ajay Verma - Professional Electrician</h3>
                                <p>
                                    Ajay is a skilled electrician with 8 years of experience in electrical installations, repairs, and maintenance.
                                </p>
                                <p>Ravi specializes in transforming neglected spaces into lush, vibrant gardens. He works independently, 
                                    offering services like pruning, mowing, weeding, and general landscape care. 
                                    His attention to detail and knowledge of native plants help maintain healthy, thriving gardens.
                                </p>
                                <h3>Specialties:</h3>
                                <div class="row">
                                    <div class="col-md-6">
                                        <ul class="list-styles">
                                            <li><i class="fa fa-check"></i> Lighting installation and repair</a></li>
                                            <li><i class="fa fa-check"></i> Electrical panel upgrades</a></li>
                                            <li><i class="fa fa-check"></i> Circuit repairs and troubleshooting</a></li>
                                            <li><i class="fa fa-check"></i>Electrical installations and wiring</a></li>
                                        </ul>
                                    </div>
                                    <div class="col-md-6">
                                        <ul class="list-styles">
                            ...
                            <div class="col-md-6">
                                <div id="single-carousel">
                                    <div class="img-hover">
                                        <div class="overlay"> <a href="\HSP\services\electrical1.jpeg" class="fancybox"><i
                                                    class="fa fa-plus-circle"></i></a></div>
                                        <img src="\HSP\services\electrical1.jpeg" alt="" class="img-responsive">
                                    </div>
                                    <div class="img-hover">
                                        <div class="overlay"> <a href="\HSP\services\electician.png" class="fancybox"><i
                                                    class="fa fa-plus-circle"></i></a></div>
                                        <img src="\HSP\services\electician.png" alt="" class="img-responsive">
                                    </div>
                                    <div class="img-hover">
                                        <div class="overlay"> <a href="\HSP\services\electician.png" class="fancybox"><i
                                                    class="fa fa-plus-circle"></i></a></div>
                ...
                <div class="container">
                    <div class="row">
                        ...
                        <ul class="social">
                            ...
                            <li class="instagram"><a href="#"> <i class="fa fa-instagram instagram-icon"></i></a></li>
