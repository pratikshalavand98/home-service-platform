            ...
            <div class="content_info">
                <div class="paddings">
                    <div class="container">
                        <div class="row">
                            <div class="col-md-6">
                                <h3>Vikram Singh - Professional Carpenter</h3>
                                <p>
                                Vikram is a highly experienced carpenter with over 15 years of experience in crafting custom furniture and home renovations. 
                                </p>
                                <p>Vikram specializes in precision woodworking, building custom cabinetry, and home repairs. 
                                    His attention to detail and craftsmanship are reflected in his work, creating durable and 
                                    aesthetically pleasing wood structures.
                                </p>
                                <h3>Specialties:</h3>
                                <div class="row">
                                    <div class="col-md-6">
                                        <ul class="list-styles">
                                            <li><i class="fa fa-check"></i>Custom furniture making</a></li>
                                            <li><i class="fa fa-check"></i>Cabinet installation</a></li>
                                            <li><i class="fa fa-check"></i>Wood repairs and refinishing</a></li>
                                            <li><i class="fa fa-check"></i>Home renovation and repairs</a></li>
                                        </ul>
                                    </div>
                            ...
                            <div class="col-md-6">
                                <div id="single-carousel">
                                    <div class="img-hover">
                                        <div class="overlay"> <a href="\HSP\services\carpenters1.jpg" class="fancybox"><i
                                                    class="fa fa-plus-circle"></i></a></div>
                                        <img src="\HSP\services\carpenters1.jpg" alt="" class="img-responsive">
                                    </div>
                                    <div class="img-hover">
                                        <div class="overlay"> <a href="\HSP\services\Carpentr.jpg" class="fancybox"><i
                                                    class="fa fa-plus-circle"></i></a></div>
                                        <img src="\HSP\services\Carpentr.jpg" alt="" class="img-responsive">
                                    </div>
                                    <div class="img-hover">
                                        <div class="overlay"> <a href="\HSP\services\Carpentr.jpg" class="fancybox"><i
                                                    class="fa fa-plus-circle"></i></a></div>
