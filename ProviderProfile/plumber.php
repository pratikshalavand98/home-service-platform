            ...
            <div class="content_info">
                <div class="paddings">
                    <div class="container">
                        <div class="row">
                            <div class="col-md-6">
                                <h3>Suresh Yadav - Professional Plumber</h3>
                                <p>
                                Suresh has been providing plumbing services for over 12 years, known for his quick and reliable solutions.
                                </p>
                                <p>Suresh specializes in resolving plumbing issues, from minor leaks to major pipe repairs.
                                He is skilled in installation and maintenance of water systems, ensuring clients enjoy trouble-free plumbing.
                                </p>
                                <h3>Specialties:</h3>
                                <div class="row">
                                    <div class="col-md-6">
                                        <ul class="list-styles">
                                            <li><i class="fa fa-check"></i> Pipe repair and installation</a></li>
                                            <li><i class="fa fa-check"></i> Leak detection and fixing</a></li>
                                            <li><i class="fa fa-check"></i> Bathroom and kitchen plumbing</a></li>
                                            <li><i class="fa fa-check"></i>Drain cleaning and clog removal</a></li>
                                        </ul>
                                    </div>
                                    <div class="col-md-6">
                                        <ul class="list-styles">
                            ...
                            <div class="col-md-6">
                                <div id="single-carousel">
                                    <div class="img-hover">
                                        <div class="overlay"> <a href="\HSP\services\plumber.jpeg" class="fancybox"><i
                                                    class="fa fa-plus-circle"></i></a></div>
                                        <img src="\HSP\services\plumber.jpeg" alt="" class="img-responsive">
                                    </div>
                                    <div class="img-hover">
                                        <div class="overlay"> <a href="\HSP\services\plumber.jpeg" class="fancybox"><i
                                                    class="fa fa-plus-circle"></i></a></div>
