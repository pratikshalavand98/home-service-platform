            ...
            <div class="content_info">
                <div class="paddings">
                    <div class="container">
                        <div class="row">
                            <div class="col-md-6">
                                <h3>Rakesh Patel - Professional Pest Control Specialist</h3>
                                <p>
                                Rakesh is a licensed pest control expert with 9 years of experience in treating infestations. 
                                </p>
                                <p>Rakesh specializes in pest removal and prevention, ensuring homes and gardens remain free of pests.
                                     His services include safe and effective treatment for common pests like ants, termites, and rodents.
                                </p>
                                <h3>Specialties:</h3>
                                <div class="row">
                                    <div class="col-md-6">
                                        <ul class="list-styles">
                                            <li><i class="fa fa-check"></i> Ant and termite control</a></li>
                                            <li><i class="fa fa-check"></i> Rodent removal and prevention</a></li>
                                            <li><i class="fa fa-check"></i> Eco-friendly pest treatments</a></li>
                                            <li><i class="fa fa-check"></i>Home and garden pest prevention</a></li>
                                        </ul>
                                    </div>
                            ...
                            <div class="col-md-6">
                                <div id="single-carousel">
                                    <div class="img-hover">
                                        <div class="overlay"> <a href="\HSP\services\pestcontrol1.png" class="fancybox"><i
                                                    class="fa fa-plus-circle"></i></a></div>
                                        <img src="\HSP\services\pestcontroler.png" alt="" class="img-responsive">
                                    </div>
                                    <div class="img-hover">
                                        <div class="overlay"> <a href="\HSP\services\pestcontrol1.png" class="fancybox"><i
                                                    class="fa fa-plus-circle"></i></a></div>
                                        <img src="\HSP\services\pestcontrol1.png" alt="" class="img-responsive">
                                    </div>
                                    <div class="img-hover">
                                        <div class="overlay"> <a href="\HSP\services\pestcontrol1.png" class="fancybox"><i
                                                    class="fa fa-plus-circle"></i></a></div>
