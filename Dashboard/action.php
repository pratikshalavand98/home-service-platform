...
if(isset($_POST["action"]))
{
             ...
             <tr>
                ...
                <td>
                   <audio id="audioMusic">
                    ...
                    <center><button type="button" onclick="ting()" name="action" class="btn btn-info btn-xs action"  data-home_id="'.$row["hsp"].'"   data-dtime="'.$dtime.'" data-user_no="'.$row["user_no"].'" data-status="'.$row["status"].'" value="" '.$disabled.' >  <span class="fa fa-check"></span> </button>
                     <br/> <br/> 
	...
	if ($_POST["action"] == 'change_status') {
		...
		$query =  'UPDATE home_tasks  SET dtime=:dtime,  status=:status WHERE  hsp=:hsp';
