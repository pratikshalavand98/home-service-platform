    ...
    <div class="modal-dialog">
      ...
      <div class="modal-content">
        <div class="modal-header">
          ...
          <h4 class="modal-title">Add New Home hsp Task:</h4>
        </div>
        <div class="container"> 
        ...
        <div class="row">
        <div class="col-lg-2">
          <label class="control-label" style="position: relative; top:7px;">HOME hsp NAME:</label>
        </div>
        <div class="col-lg-10">
           <input type="hidden" style="width: 300px;"  class="form-control"   name="name" value="<?php echo $f['name'];?>">
          <input type="text" style="width: 300px;"  class="form-control"   name="hsp">
