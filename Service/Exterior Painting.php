...
<head>
    ...
    if (selectedSize === '1BHK') {
        basePrice = 5200; // Price for 1BHK
    } else if (selectedSize === '2BHK') {
        basePrice = 10400; // Price for 2BHK
    } else if (selectedSize === '3BHK') {
        basePrice = 28000; // Price for 3BHK
    } else if (selectedSize === '4BHK') {
        basePrice = 30000; // Price for 4BHK
    }
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="post-header">
                                                ...
                                                <div class="post-info-wrap">
                                                    <h2 class="post-title"><a href="#" title="Post Format: Standard" rel="bookmark">Exterior Painting</a></h2>
                                        ...
                                        <div class="col-md-12">
                                            <div id="single-carousel">
                                                <div class="img-hover">
                                                    <img src="/HSP\Service\images\Exterior Painting.jpg" alt="" class="img-responsive">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-12">
                                            <div class="post-content">
                                                ...
                                                <p>Exterior painting focuses on the application of weather-resistant paint to the outside surfaces of homes,
                                                     including walls, fences, decks, and other structures. The process involves extensive surface preparation, such as scraping, sanding, and
                                                      priming, to ensure that the paint adheres properly and lasts longer. Exterior painting not only refreshes the appearance of a home, improving its curb appeal, 
                                                      but also adds a layer of protection against the elements, such as sun, rain, and wind. By providing both aesthetic and 
                                                    functional benefits, this service helps maintain the longevity and value of a property.</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                        ...
                                        <div class="panel-body">
                                            <table class="table">
                                                <tr>
                                                    ...
                                                    <td style="border-top: none;" id="price">₹5100</td>
                                                </tr>
                                                <tr>
                                         <td>Size</td>
                                               <td>
