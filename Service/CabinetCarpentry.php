...
<head>
    ...
    <script>
        ...
        function calculatePrice() {
            let basePrice = 6500; // Base price for default size
            ...
            if (selectedSize === '7x8') {
                basePrice = 6500; // Default price
            } else if (selectedSize === '10x12') {
                basePrice = 12500; // Larger size price
            } else if (selectedSize === '12x15') {
                basePrice = 24500; // Even larger size price
            }
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="post-header">
                                                ...
                                                <div class="post-info-wrap">
                                                    <h2 class="post-title"><a href="#" title="Post Format: Standard" rel="bookmark">Cabinet Installation</a></h2>
                                        ...
                                        <div class="col-md-12">
                                            <div id="single-carousel">
                                                <div class="img-hover">
                                                    <img src="\HSP\Service\images\Cabinet Installation1.jpg" alt="" class="img-responsive">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-12">
                                            <div class="post-content">
                                                ...
                                                <p>Cabinet installation is a specialized service that involves the assembly and secure installation of 
                                                    cabinets, typically in kitchens, bathrooms, or other areas where storage is needed. The process requires precise measurement, 
                                                    careful leveling, and ensuring that the cabinets are properly aligned and securely attached to walls or surfaces. Customizable 
                                                    designs are often offered to suit the specific preferences and spatial requirements of homeowners, making this a service that 
                                                    combines functionality with aesthetic appeal. Cabinet installation requires skilled professionals
                                                     who are experienced in carpentry to ensure that the installation is durable, functional, and visually appealing.</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                        ...
                                        <div class="panel-body">
                                            <table class="table">
                                                <tr>
                                                    ...
                                                    <td style="border-top: none;" id="price">₹6500</td>
                                                </tr>
                                                <tr>
                                                    <td>Size</td>
                                                    <td>
                                                        <select id="sizeSelect" onchange="calculatePrice()">
                                                            <option value="7x8">56sq ft (7' x 8')</option>
                                                            <option value="10x12">120sq ft (10' x 12')</option>
                                                            <option value="12x15">180sq ft (12' x 15')</option>
                                                        </select>
                                                    </td>
                                                </tr>
                                                <tr>
