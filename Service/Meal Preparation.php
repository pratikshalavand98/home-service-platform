...
<body>
                                    ...
                                    <div class="row">
                                            ...
                                            <div class="post-header">
                                                ...
                                                <div class="post-info-wrap">
                                                    <h2 class="post-title"><a href="#" title="Post Format: Standard"
                                                            rel="bookmark">Meal Preparation</a></h2>
                                        ...
                                        <div class="col-md-12">
                                            <div id="single-carousel">
                                                <div class="img-hover">
                                                    <img src="\HSP\Service\images\MealPreparation.jpg" alt=""
                                        ...
                                        <div class="col-md-12">
                                            <div class="post-content">
                                                ...
                                                <p>Meal preparation involves planning, cooking, and portioning out meals in advance. This service is particularly useful 
                                                    for those with busy schedules, helping to ensure that nutritious, home-cooked meals are available throughout the week.</p>
    ...
    <tr>
        ...
        <td style="border-top: none;">₹<span id="pricePerDay">20</span></td>
    </tr>
    <tr>
        <td>Duration</td>
        <td>
    ...
    <tr>
        <td>Total</td>
        <td>₹<span id="totalPrice">20</span></td>
    </tr>
</table>
