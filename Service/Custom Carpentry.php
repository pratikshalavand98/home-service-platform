...
<head>
    ...
    <script>
        ...
        function calculatePrice() {
            let basePrice = 6000; // Base price for default size
            ...
            if (selectedSize === '7x8') {
                basePrice = 6000; // Default price
            } else if (selectedSize === '10x12') {
                basePrice = 12000; // Larger size price
            } else if (selectedSize === '12x15') {
                basePrice = 24000; // Even larger size price
            }
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="post-header">
                                                ...
                                                <div class="post-info-wrap">
                                                    <h2 class="post-title"><a href="#" title="Post Format: Standard" rel="bookmark">Custom Carpentry</a></h2>
                                        ...
                                        <div class="col-md-12">
                                            <div id="single-carousel">
                                                <div class="img-hover">
                                                    <img src="\HSP\Service\images\Carpenters.jpg" alt="" class="img-responsive">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-12">
                                            <div class="post-content">
                                                ...
                                                <p>Custom carpentry is a tailored woodworking service that provides homeowners with personalized solutions 
                                                    for furniture, shelves, moldings, staircases, and other wood-based features. Unlike mass-produced options, 
                                                    custom carpentry allows for unique, bespoke designs that fit the specific style and functional needs of the 
                                                    home. This service demands a high level of craftsmanship and expertise, as it involves using professional
                                                     tools and techniques to create high-quality, durable products. Custom carpentry not only enhances the visual
                                                      appeal of
                                                     a home but also increases its practical value by addressing specific design needs.</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                        ...
                                        <div class="panel-body">
                                            <table class="table">
                                                <tr>
                                                    ...
                                                    <td style="border-top: none;" id="price">₹6000</td>
                                                </tr>
                                                <tr>
                                                    <td>Size</td>
                                                    <td>
