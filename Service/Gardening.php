...
<head>
  ...
  <script>
    ...
    var pricePerFoot = 150; // Fixed price per foot
...
<body>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-12">
                                            <div id="single-carousel">
                                                <div class="img-hover">
                                                    <img src="\HSP\Service\images\gardeners.jpg" alt=""
                                        ...
                                        <div class="col-md-12">
                                            <div class="post-content">
                                                <h3>Gardening</h3>
                                                <p>Gardening involves the cultivation and maintenance of plants, flowers, and shrubs in a garden. 
                                                    It includes planting, watering, weeding, and pruning to promote plant health and create an attractive outdoor space.</p>
    ...
    <tr>
        ...
        <td style="border-top: none;"> <span id="pricePerFoot">₹150</span></td>
    </tr>
    <tr>
        <td>Size (in feet)</td>
        <td>
    ...
    <tr>
        <td>Total</td>
        <td> <span id="totalPrice">₹150</span></td>
    </tr>
</table>
                                        </div>
