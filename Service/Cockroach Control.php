...
<head>
    ...
    if (selectedSize === '1BHK') {
        basePrice = 1100; // Price for 1BHK
    } else if (selectedSize === '2BHK') {
        basePrice = 1300; // Price for 2BHK
    } else if (selectedSize === '3BHK') {
        basePrice = 1500; // Price for 3BHK
    } else if (selectedSize === '4BHK') {
        basePrice = 2000; // Price for 4BHK
    }
                                    ...
                                    <div class="row">
                                            ...
                                            <div class="post-header">
                                                ...
                                                <div class="post-info-wrap">
                                                    <h2 class="post-title"><a href="#" title="Post Format: Standard"
                                                            rel="bookmark">Pesticides:Cockroach Control</a></h2>
                                        ...
                                        <div class="col-md-12">
                                            <div id="single-carousel">
                                                <div class="img-hover">
                                                    <img src="\HSP\Service\images\Cockroach.jpeg" alt=""
                                        ...
                                        <div class="col-md-12">
                                            <div class="post-content">
                                                <h3>Pesticides:Cockroach Control</h3>
                                                <p>Cockroach control aims to manage infestations of cockroaches, which are resilient pests that can contaminate food and spread disease. Treatment involves insecticides, traps, and sanitation measures to prevent their spread.</p>
                                    ...
                                    <div class="panel panel-default">
                                        ...
                                        <table class="table">
                                                <tr>
                                                    ...
                                                    <td style="border-top: none;" id="price">₹1100</td>
                                                </tr>
                                                <tr>
    <td>Size</td>
    <td>
