...
<head>
    ...
    if (selectedSize === '1BHK') {
        basePrice = 3200; // Price for 1BHK
    } else if (selectedSize === '2BHK') {
        basePrice = 6400; // Price for 2BHK
    } else if (selectedSize === '3BHK') {
        basePrice = 12800; // Price for 3BHK
    } else if (selectedSize === '4BHK') {
        basePrice = 42600; // Price for 4BHK
    }
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="post-header">
                                                ...
                                                <div class="post-info-wrap">
                                                    <h2 class="post-title"><a href="#" title="Post Format: Standard" rel="bookmark">Wallpaper Installation</a></h2>
                                        ...
                                        <div class="col-md-12">
                                            <div id="single-carousel">
                                                <div class="img-hover">
                                                    <img src="\HSP\Service\images\Wallpaper Installation1.jpg" alt="" class="img-responsive">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-12">
                                            <div class="post-content">
                                                ...
                                                <p>Wallpaper installation via an online home service platform simplifies the process for homeowners. Customers can easily 
                                                    browse designs, book professional installers, and schedule services at their convenience. The platform ensures transparent pricing, access to customer reviews, and quality workmanship, making home improvement hassle-free and efficient.
                                                     This service meets the demand for accessible, professional solutions in home decor.</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                        ...
                                        <div class="panel-body">
                                            <table class="table">
                                                <tr>
                                                    ...
                                                    <td style="border-top: none;" id="price">₹3500</td>
                                                </tr>
                                                <tr>
                                                <td>Size</td>
                                                      <td>
