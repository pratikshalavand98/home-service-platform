...
<head>
    ...
    // Get the price per foot
    var pricePerFoot = 250; // Fixed price per foot

    // Get the selected size (in feet)
    var sizeSelect = document.getElementById('sizeSelect');
    var selectedSize = parseInt(sizeSelect.value);

    // Calculate the total price
    var totalPrice = pricePerFoot * selectedSize;
...
<body>
                                    ...
                                    <div class="row">
                                            ...
                                            <div class="post-header">
                                                ...
                                                <div class="post-info-wrap">
                                                    <h2 class="post-title"><a href="#" title="Post Format: Standard"
                                                            rel="bookmark">Gardening:Lawn Care</a></h2>
                                        ...
                                        <div class="col-md-12">
                                            <div id="single-carousel">
                                                <div class="img-hover">
                                                    <img src="\HSP\Service\images\lawncare.jpeg" alt=""
                                        ...
                                        <div class="col-md-12">
                                            <div class="post-content">
                                                <h3>Gardening:Lawn Care</h3>
                                                <p>Lawn care is focused on maintaining the health and appearance of a lawn.
                                                     This service includes mowing, fertilizing, aerating, and weed control to keep the grass in good condition and ensure a lush, green landscape.</p>
                            ...
                            <div class="col-md-4">
                                <aside class="widget" style="margin-top: 18px;">
                                    <div class="panel panel-default">
                                        ...
                                        <table class="table">
    <tr>
        <td style="border-top: none;">Price per foot</td>
        <td style="border-top: none;"> <span id="pricePerFoot">₹250</span></td>
    </tr>
    <tr>
        <td>Size (in feet)</td>
        <td>
            <select id="sizeSelect" onchange="calculateTotalPrice()">
    ...
    <tr>
        <td>Discount</td>
        <td><span id="discount">&#36;</span> 0</td>
    </tr>
    <tr>
        <td>Total</td>
        <td> <span id="totalPrice">₹250</span></td>
    </tr>
</table>
                                        </div>
