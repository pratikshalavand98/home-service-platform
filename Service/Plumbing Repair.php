                                    ...
                                    <div class="row">
                                            ...
                                            <div class="post-header">
                                                ...
                                                <div class="post-info-wrap">
                                                    <h2 class="post-title"><a href="#" title="Post Format: Standard"
                                                            rel="bookmark">Plumbing Repair</a></h2>
                                        ...
                                        <div class="col-md-12">
                                            <div id="single-carousel">
                                                <div class="img-hover">
                                                    <img src="\HSP\services\plumbing.jpeg" alt=""
                                        ...
                                        <div class="col-md-12">
                                            <div class="post-content">
                                                ...
                                                <p>Plumbing refers to the installation and maintenance of systems that convey fluids, such as water and gas, within a structure. Plumbers work on pipes,
                                                     tanks, and other fittings, ensuring water supply and waste removal systems are functional and compliant with safety standards.</p>
    ...
    <tr>
        ...
        <td>
            <select id="damageSelect" onchange="calculatePrice()">
                <option value="00" data-hourly-rate="300">Shower and Bathtub Repair</option>
                <option value="400" data-hourly-rate="400">Sewer Line Repair</option>
                <option value="800" data-hourly-rate="800">Pipe Repair and Replacement</option>
                <option value="600" data-hourly-rate="600"> Leaky Faucet Repair</option>
            </select>
        </td>
    </tr>
    <tr>
