...
<head>
    ...
    // Get the selected pest type multiplier
    var pestTypeMultiplier = parseFloat(document.getElementById('pestType').value);

    // Get the area in square feet
    var area = parseInt(document.getElementById('area').value);

    // Calculate the total price (Base Price * Area * Pest Type Multiplier)
    var totalPrice = basePrice * area * pestTypeMultiplier;

    // Set discount logic (optional, currently 0)
    var discount = 0;
...
<body>
                                    ...
                                    <div class="row">
                                            ...
                                            <div class="post-header">
                                                ...
                                                <div class="post-info-wrap">
                                                    <h2 class="post-title"><a href="#" title="Post Format: Standard"
                                                            rel="bookmark">Pesticides:Rodent Control</a></h2>
                                        ...
                                        <div class="col-md-12">
                                            <div id="single-carousel">
                                                <div class="img-hover">
                                                    <img src="\HSP\Service\images\PesticidesRodent Control.jpeg" alt=""
                                        ...
                                        <div class="col-md-12">
                                            <div class="post-content">
                                                <h3>Pesticides:Rodent Control</h3>
                                                <p>Rodent control targets the elimination of rats and mice, which can carry diseases and cause property damage. This service may include setting traps, sealing entry points, and using repellents to keep rodents at bay.</p>
                            ...
                            <div class="col-md-4">
                                <aside class="widget" style="margin-top: 18px;">
                                    <div class="panel panel-default">
                                        ...
                                        <table class="table">
    <tr>
        <td style="border-top: none;">Base Price</td>
        <td style="border-top: none;">₹<span id="basePrice">500</span></td>
    </tr>
    <tr>
        <td>Area (in sq ft)</td>
        <td>
            <input type="number" id="area" value="1" min="1" oninput="calculateTotalPrice()">
        </td>
    </tr>
    <tr>
        <td>Select Pest Type</td>
        <td>
            <select id="pestType" onchange="calculateTotalPrice()">
                <option value="1">General Insects</option>
                <option value="1.5">Termites</option>
                <option value="2">Rodents</option>
            </select>
        </td>
    </tr>
    <tr>
    ...
    <tr>
        <td>Total</td>
        <td>₹<span id="totalPrice">500</span></td>
    </tr>
</table>
                                        </div>
