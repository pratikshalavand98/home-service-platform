...
<head>
    ...
    var pricePerFoot = 300; // Fixed price per foot
...
<body>
                                    ...
                                    <div class="row">
                                            ...
                                            <div class="post-header">
                                                ...
                                                <div class="post-info-wrap">
                                                    <h2 class="post-title"><a href="#" title="Post Format: Standard"
                                                            rel="bookmark">Garden Design</a></h2>
                                        ...
                                        <div class="col-md-12">
                                            <div id="single-carousel">
                                                <div class="img-hover">
                                                    <img src="\HSP\Service\images\Garden Design.jpg" alt=""
                                        ...
                                        <div class="col-md-12">
                                            <div class="post-content">
                                                <h3>Garden Design</h3>
                                                <p>Garden design involves creating a functional and aesthetically pleasing layout
                                                     for a garden, taking into account the types of plants, landscape features, and personal preferences of the homeowner.</p>
    ...
    <tr>
        ...
        <td style="border-top: none;"> <span id="pricePerFoot">₹300</span></td>
    </tr>
    <tr>
        <td>Size (in feet)</td>
        <td>
