                                    ...
                                    <div class="row">
                                            ...
                                            <div class="post-header">
                                                ...
                                                <div class="post-info-wrap">
                                                    <h2 class="post-title"><a href="#" title="Post Format: Standard"
                                                            rel="bookmark">Deep Cleaning</a></h2>
                                        ...
                                        <div class="col-md-12">
                                            <div id="single-carousel">
                                                <div class="img-hover">
                                                    <img src="\HSP\Service\images\Deep Cleaning.jpeg" alt=""
                                        ...
                                        <div class="col-md-12">
                                            <div class="post-content">
                                                <h3>Deep Cleaning</h3>
                                                <p>Deep cleaning involves a more thorough cleaning process that targets areas not typically
                                                     covered by regular cleaning routines. This may include cleaning under appliances,
                                                      scrubbing grout, and eliminating built-up dirt and grime in hard-to-reach areas.</p>
