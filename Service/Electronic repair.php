...
<body>
                                    ...
                                    <div class="row">
                                            ...
                                            <div class="post-header">
                                                ...
                                                <div class="post-info-wrap">
                                                    <h2 class="post-title"><a href="#" title="Post Format: Standard"
                                                            rel="bookmark">Electronic repair</a></h2>
                                        ...
                                        <div class="col-md-12">
                                            <div id="single-carousel">
                                                <div class="img-hover">
                                                    <img src="/HSP\services\2.jpg" alt=""
                                        ...
                                        <div class="col-md-12">
                                            <div class="post-content">
                                                ...
                                                <p>Electronic repair involves the maintenance and repair of various household or commercial 
                                                    electrical devices, ensuring that they function correctly and efficiently.
                                                     It requires understanding the electrical circuits, components, and devices and diagnosing faults to repair or replace damaged parts.</p>
    ...
    <tr>
        ...
        <td style="border-top: none;" id="price">₹200</td>
    </tr>
    <tr>
        <td>Select Type</td>
        <td>
            <select id="damageSelect" onchange="calculatePrice()">
                <option value="200" data-hourly-rate="200">Laptop and Computer Repair</option>
                <option value="400" data-hourly-rate="400">Home Appliance Repair</option>
                <option value="800" data-hourly-rate="800">Camera Repair</option>
                <option value="600" data-hourly-rate="600">Audio and Video Equipment Repair</option>
            </select>
        </td>
    </tr>
    <tr>
