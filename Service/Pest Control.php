...
<body>
                                    ...
                                    <div class="row">
                                            ...
                                            <div class="post-header">
                                                ...
                                                <div class="post-info-wrap">
                                                    <h2 class="post-title"><a href="#" title="Post Format: Standard"
                                                            rel="bookmark">Pest Control</a></h2>
                                        ...
                                        <div class="col-md-12">
                                            <div id="single-carousel">
                                                <div class="img-hover">
                                                    <img src="\HSP\Service\images\pestcontrol.jpg" alt=""
                                        ...
                                        <div class="col-md-12">
                                            <div class="post-content">
                                                <h3>Pest Control</h3>
                                                <p>Pest control involves the management and elimination of pests such as insects and rodents from homes or businesses. Techniques may include the use of chemicals, traps, or natural deterrents to reduce pest infestations and minimize damage to property.</p>
    ...
    <tr>
        ...
        <td style="border-top: none;">₹<span id="basePrice">300</span></td>
    </tr>
    <tr>
        <td>Area (in sq ft)</td>
        <td>
    ...
    <tr>
        <td>Total</td>
        <td>₹<span id="totalPrice">300</span></td>
    </tr>
</table>
