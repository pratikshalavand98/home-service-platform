...
<head>
    ...
    let selectedOption = document.getElementById('timeSelect').selectedOptions[0];
    let hourlyRate = parseInt(selectedOption.getAttribute('data-hourly-rate'));
    let hours = parseInt(selectedOption.value);
    let priceElement = document.getElementById('price');
    let totalPriceElement = document.getElementById('totalPrice');

    // Calculate the total price based on the hourly rate and selected hours
                                    ...
                                    <div class="row">
                                            ...
                                            <div class="post-header">
                                                ...
                                                <div class="post-info-wrap">
                                                    <h2 class="post-title"><a href="#" title="Post Format: Standard"
                                                            rel="bookmark">Electronic:Get connection</a></h2>
                                        ...
                                        <div class="col-md-12">
                                            <div class="post-content">
                                                <h3>Electronic:Get connection</h3>
                                                <p>Getting a connection refers to setting up electrical, water, or gas services in a home or business. 
                                                    This process often involves working with utility 
                                                    companies to establish or transfer services to a new location, ensuring all legal and safety requirements are met.</p>
                                        ...
                                        <div class="panel-body">
                                            <table class="table">
                                                <tr>
                                                    ...
                                                    <td style="border-top: none;">₹566</td>
                                                </tr>
