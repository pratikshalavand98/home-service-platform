...
function calculateTotalPrice() {
    ...
    var pricePerDay = parseInt(document.getElementById('pricePerDay').innerText);

    // Get the selected duration multiplier (1 for per day, 7 for per week, 30 for per month)
    var durationMultiplier = parseInt(document.getElementById('duration').value);

    // Calculate total price based on the duration selected
    var totalPrice = pricePerDay * durationMultiplier;

    // Set discount logic (optional)
    var discount = 0; // No discount for now, can modify based on your need
...
<body>
                                    ...
                                    <div class="row">
                                            ...
                                            <div class="post-header">
                                                ...
                                                <div class="post-info-wrap">
                                                    <h2 class="post-title"><a href="#" title="Post Format: Standard"
                                                            rel="bookmark">Personal Chef</a></h2>
                                        ...
                                        <div class="col-md-12">
                                            <div id="single-carousel">
                                                <div class="img-hover">
                                                    <img src="\HSP\Service\images\cook1.jpg" alt=""
                                        ...
                                        <div class="col-md-12">
                                            <div class="post-content">
                                                <h3>Personal Chef</h3>
                                                <p>A personal chef is a professional who prepares meals tailored to the specific dietary preferences and needs of an individual or family. 
                                                    They plan menus, shop for ingredients, and cook meals in a client's home, offering convenience and personalized service.</p>
                            ...
                            <div class="col-md-4">
                                <aside class="widget" style="margin-top: 18px;">
                                    <div class="panel panel-default">
                                        ...
                                        <table class="table">
    <tr>
        <td style="border-top: none;">Price per day</td>
        <td style="border-top: none;">₹<span id="pricePerDay">100</span></td>
    </tr>
    <tr>
        <td>Duration</td>
        <td>
            <select id="duration" onchange="calculateTotalPrice()">
    ...
    <tr>
        <td>Total</td>
        <td>₹<span id="totalPrice">100</span></td>
    </tr>
</table>
                                        </div>
