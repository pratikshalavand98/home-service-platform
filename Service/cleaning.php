...
<head>
    ...
    if (selectedSize === '1BHK') {
        basePrice = 2999; // Price for 1BHK
    } else if (selectedSize === '2BHK') {
        basePrice = 3999; // Price for 2BHK
    } else if (selectedSize === '3BHK') {
        basePrice = 4999; // Price for 3BHK
    } else if (selectedSize === '4BHK') {
        basePrice = 5999; // Price for 4BHK
    }
                                    ...
                                    <div class="row">
                                            ...
                                            <div class="post-header">
                                                ...
                                                <div class="post-info-wrap">
                                                    <h2 class="post-title"><a href="#" title="Post Format: Standard"
                                                            rel="bookmark">Move-In/Move-Out Cleaning</a></h2>
                                        ...
                                        <div class="col-md-12">
                                            <div id="single-carousel">
                                                <div class="img-hover">
                                                    <img src="\HSP\Service\images\moveincleaning.jpeg" alt=""
                                        ...
                                        <div class="col-md-12">
                                            <div class="post-content">
                                                ...
                                                <p>Move-in/move-out cleaning is a service provided when someone is moving into or out of a property. This thorough cleaning ensures that the home is in good condition for new occupants, removing dust, stains, and residues left behind by previous tenants.</p>
                                        ...
                                        <div class="panel-body">
                                            <table class="table">
                                                <tr>
                                                    ...
                                                    <td style="border-top: none;" id="price">₹2999</td>
                                                </tr>
                                                <tr>
    <td>Size</td>
    <td>
