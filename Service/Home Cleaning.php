                                    ...
                                    <div class="row">
                                            ...
                                            <div class="post-header">
                                                ...
                                                <div class="post-info-wrap">
                                                    <h2 class="post-title"><a href="#" title="Post Format: Standard"
                                                            rel="bookmark">Home Cleaning</a></h2>
                                        ...
                                        <div class="col-md-12">
                                            <div id="single-carousel">
                                                <div class="img-hover">
                                                    <img src="\HSP\Service\images\service_13.jpg" alt=""
                                        ...
                                        <div class="col-md-12">
                                            <div class="post-content">
                                                <h3>Home Cleaning</h3>
                                                <p>Home cleaning refers to the general cleaning and upkeep of a home, ensuring it is free from dust
                                                    , dirt, and other contaminants. This service may include vacuuming, mopping, dusting, and other tasks to maintain cleanliness.</p>
